     ...
     <div>
         ...
         {item.user && (
           ...
           >
             {item.user.avatar ? (
               ...
               <div>{item.user.name && item.user.name[0].toUpperCase()}</div>
             )}
           </Avatar>
         )}
       </div>
       ...
       <span>
         {item.emoji === "corazon" ? (
           ...
           <i className="ri-error-warning-fill" style={{ color: "#7e00e5" }}></i>
         ) : (
           <i className="ri-emotion-normal-fill" style={{ color: "#9463ec" }}></i>
         )}
       </span>
     </div>
     <p>{item.text}</p>
