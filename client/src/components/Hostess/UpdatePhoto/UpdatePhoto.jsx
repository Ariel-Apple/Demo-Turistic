...
const UpdatePhoto = () => {
  ...
  const allPhotos = datapersonal && datapersonal.Posts && datapersonal.Posts.map((data) => data.imageFile.map(photo => photo));
  ...
  return (
    <>
      <Upload
        ...
        fileList={allPhotos.flat().map((photo, index) => ({ uid: String(index), name: photo.name, status: 'done', url: photo }))}
